...
import frc.robot.controllers.SettableEncoder;
...
public class LifterSubsystem extends BaseSubsystem {
    ...
    public static final double UP_SPEED_PERCENT = 0.85;
    public static final double DOWN_SPEED_PERCENT = 0.80 ;
    ...
    public static final int RAMP_DOWN_COUNTS = 600;
